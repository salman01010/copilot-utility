---
name: Bug Triage
description: Triage a support ticket — find prior-art fixes, route to the right repo, propose a fix.
...
## Tools available
- Atlassian MCP (`.vscode/mcp.json`): read JIRA tickets, search past issues.
- GitHub MCP (`.vscode/mcp.json`): search code, issues, and PRs across repos I can access.
